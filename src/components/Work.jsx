...
function Work() {
  ...
  return (
    ...
    className='bg-gray-800 pb-28 mt-10 pt-2'>
      <div className='container'>
        <div className='items-center p-4 pt-10 mt-10 w-2/5 mx-auto justify-center'>
            <h1 className='text-center font-bold text-7xl text-white font-roboto'>How It Work</h1>
        ...
        <div className='flex justify-between mx-auto mt-10 pb-4'>
            <div>
                ...
                <p className='w-64 text-center text-gray-400 font-roboto text-md mt-1'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            <div>
